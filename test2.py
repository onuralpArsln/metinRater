...
def main():
    ...
    # --- 4. VISUALIZATION 1: t-SNE Scatter Plot ---
    ...
    plt.legend()
    plt.savefig("kategori/2_tsne.png")
    print("Saved: kategori/2_tsne.png")
    ...
    with open("kategori/2_tsne_data.txt", "w", encoding="utf-8") as f:
        f.write("\n".join(tsne_data))
    print("Saved: kategori/2_tsne_data.txt")
    ...
    report.append("- kategori/2_similarity_bars.png: 1D closeness chart pitting success vs failure bigram similarity.")
    report.append("- kategori/2_tsne.png: t-SNE scatter plot of vectors using the enhanced TF-IDF model.")
    report.append("\n")
