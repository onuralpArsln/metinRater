...
def main():
    ...
    plt.title("Approach 5 Embedding Clusters (SVD + t-SNE)")
    plt.legend()
    plt.savefig("kategori/5_tsne.png")
    print("Saved: kategori/5_tsne.png")
    ...
    with open("kategori/5_tsne_data.txt", "w", encoding="utf-8") as f:
        f.write("\n".join(tsne_data))
    print("Saved: kategori/5_tsne_data.txt")
    ...
    ax.set_title('Test Text Closeness to Profiles (Test 5 - Char N-Grams)')
    ax.set_xticks(x)
    ax.set_xticklabels(test_labels)
    ax.legend()
    plt.grid(axis='y', linestyle='--', alpha=0.7)
    plt.tight_layout()
    plt.savefig("kategori/5_similarity_bars.png")
    print("Saved: kategori/5_similarity_bars.png")
