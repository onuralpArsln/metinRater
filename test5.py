...
def main():
    ...
    report.append("- kategori/5_pca.png: PCA scatter plot mapping the text neighborhood.")
    report.append("- kategori/5_similarity_bars.png: 1D closeness chart comparing success vs failure similarity.")
